...
public class Controller {
    ...
    public void initialize(){
        ...
        buttonAdd.setGraphic(new ImageView("images/reminder.png"));
        buttonDelete.setGraphic(new ImageView("images/delete.png"));
        buttonExit.setGraphic(new ImageView("images/exit.png"));
        filterToggleButton.setMinHeight(58);
        filterToggleButton.setMinWidth(50);
